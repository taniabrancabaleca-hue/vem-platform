...
export default function PedidosParceiroList() {
  ...
  if (erro) {
    return (
      <div style={{ background: "#fee2e2", border: "1px solid #fca5a5", borderRadius: 8, padding: 16, color: "#991b1b", fontSize: 13 }}>
        {erro}
      </div>
    );
  }
      ...
      {pedidos.map((p) => (
        <div key={p.id} style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            <span style={{ fontSize: 13, fontWeight: 600, color: "#1B65B2" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px 24px", marginBottom: 12 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 13, fontWeight: 600, color: "#1a1a18", margin: 0 }}>
                {new Date(p.data_transporte).toLocaleDateString("pt-PT")}
              </p>
            </div>
            <div>
