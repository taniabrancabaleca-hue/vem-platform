      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: tc.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>
              🏥
            </div>
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 4 }}>
                <span style={{ fontSize: 12, background: tc.bg, color: tc.color, padding: '2px 10px', borderRadius: 20, fontWeight: 500 }}>
                  {TIPO_LABEL[inst.tipo]}
                </span>
                  ...
                  <tr key={p.id}>
                    ...
                    <td>
                      <span className={`badge badge-${p.estado}`}>
                        {p.estado === 'concluido' ? 'Concluído' : p.estado === 'pendente' ? 'Pendente' : p.estado === 'cancelado' ? 'Cancelado' : p.estado}
                      </span>
                    </td>
                  </tr>
                ))}
